...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Parameters, channels_),
...
// required int32 channels = 4 [default = 8];
bool Parameters::has_channels() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
void Parameters::set_has_channels() {
  _has_bits_[0] |= 0x00000010u;
}
void Parameters::clear_has_channels() {
  _has_bits_[0] &= ~0x00000010u;
}
void Parameters::clear_channels() {
  channels_ = 8;
  clear_has_channels();
}
::google::protobuf::int32 Parameters::channels() const {
  // @@protoc_insertion_point(field_get:Beta.Parameters.channels)
  return channels_;
}
void Parameters::set_channels(::google::protobuf::int32 value) {
  set_has_channels();
  channels_ = value;
