...
class Parameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Beta.Parameters) */ {
 ...
 private:
  ...
  friend void ::protobuf_beta_2eproto::InitDefaultsParametersImpl();
};
// ===================================================================
...
inline void Parameters::clear_type() {
  type_.ClearToDefaultNoArena(&::Beta::Parameters::_default_type_.get());
  clear_has_type();
}
...
inline void Parameters::set_type(const ::std::string& value) {
  set_has_type();
  type_.SetNoArena(&::Beta::Parameters::_default_type_.get(), value);
...
inline void Parameters::set_type(::std::string&& value) {
  set_has_type();
  type_.SetNoArena(
    &::Beta::Parameters::_default_type_.get(), ::std::move(value));
...
inline void Parameters::set_type(const char* value) {
  ...
  set_has_type();
  type_.SetNoArena(&::Beta::Parameters::_default_type_.get(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:Beta.Parameters.type)
}
inline void Parameters::set_type(const char* value, size_t size) {
  set_has_type();
  type_.SetNoArena(&::Beta::Parameters::_default_type_.get(),
...
inline ::std::string* Parameters::mutable_type() {
  ...
  return type_.MutableNoArena(&::Beta::Parameters::_default_type_.get());
}
inline ::std::string* Parameters::release_type() {
  // @@protoc_insertion_point(field_release:Beta.Parameters.type)
  clear_has_type();
  return type_.ReleaseNoArena(&::Beta::Parameters::_default_type_.get());
}
inline void Parameters::set_allocated_type(::std::string* type) {
  ...
  type_.SetAllocatedNoArena(&::Beta::Parameters::_default_type_.get(), type);
...
// required int32 channels = 4 [default = 8];
inline bool Parameters::has_channels() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void Parameters::set_has_channels() {
  _has_bits_[0] |= 0x00000010u;
}
inline void Parameters::clear_has_channels() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void Parameters::clear_channels() {
  channels_ = 8;
  clear_has_channels();
}
inline ::google::protobuf::int32 Parameters::channels() const {
  // @@protoc_insertion_point(field_get:Beta.Parameters.channels)
  return channels_;
}
inline void Parameters::set_channels(::google::protobuf::int32 value) {
  set_has_channels();
  channels_ = value;
  // @@protoc_insertion_point(field_set:Beta.Parameters.channels)
}
