...
OperatorDef* Net::AddOp(const std::string& name,
...
OperatorDef* Net::AddCreateDbOp(const std::string& reader,
...
OperatorDef* Net::AddTensorProtosDbInputOp(const std::string& reader,
...
OperatorDef* Net::AddCoutOp(const std::vector<std::string>& params) {
  return AddOp("Cout", params, {});
}

OperatorDef* Net::AddZeroOneOp(const std::string& pred,
                                   const std::string& label) {
  return AddOp("ZeroOne", {pred, label}, {});
}

OperatorDef* Net::AddShowWorstOp(const std::string& pred,
                                     const std::string& label,
...
OperatorDef* Net::AddTimePlotOp(const std::string& data,
...
OperatorDef* Net::AddEnsureCpuOutputOp(const std::string& input,
                                           const std::string& output) {
  return AddOp("EnsureCPUOutput", {input}, {output});
}

OperatorDef* Net::AddCopyFromCpuInputOp(const std::string& input,
                                            const std::string& output) {
  return AddOp("CopyFromCPUInput", {input}, {output});
}

OperatorDef* Net::AddCopyOp(const std::string& input,
                                const std::string& output) {
  return AddOp("Copy", {input}, {output});
}

OperatorDef* Net::AddCreateMutexOp(const std::string& param) {
  return AddOp("CreateMutex", {}, {param});
}

OperatorDef* Net::AddPrintOp(const std::string& param, bool to_file) {
...
OperatorDef* Net::AddConstantFillOp(const std::vector<int>& shape,
...
OperatorDef* Net::AddXavierFillOp(const std::vector<int>& shape,
                                      const std::string& param) {
...
OperatorDef* Net::AddUniformFillOp(const std::vector<int>& shape, float min,
...
OperatorDef* Net::AddConstantFillWithOp(float value,
...
OperatorDef* Net::AddVectorFillOp(const std::vector<int>& values,
...
OperatorDef* Net::AddGivenTensorFillOp(const TensorCPU& tensor,
                                           const std::string& name) {
...
OperatorDef* Net::AddConvOp(const std::string& input, const std::string& w,
...
OperatorDef* Net::AddReluOp(const std::string& input,
                                const std::string& output) {
  return AddOp("Relu", {input}, {output});
}

OperatorDef* Net::AddLrnOp(const std::string& input,
...
OperatorDef* Net::AddMaxPoolOp(const std::string& input,
...
OperatorDef* Net::AddAveragePoolOp(const std::string& input,
                                       const std::string& output, int stride,
                                       int padding, int kernel,
                                       const std::string& order) {
...
OperatorDef* Net::AddFcOp(const std::string& input, const std::string& w,
                              const std::string& b, const std::string& output,
                              int axis) {
...
OperatorDef* Net::AddDropoutOp(const std::string& input,
...
OperatorDef* Net::AddSoftmaxOp(const std::string& input,
...
OperatorDef* Net::AddConcatOp(const std::vector<std::string>& inputs,
                                  const std::string& output,
                                  const std::string& order) {
...
OperatorDef* Net::AddLSTMUnitOp(const std::vector<std::string>& inputs,
                                    const std::vector<std::string>& outputs,
...
OperatorDef* Net::AddAccuracyOp(const std::string& pred,
                                    const std::string& label,
...
OperatorDef* Net::AddLabelCrossEntropyOp(const std::string& pred,
                                             const std::string& label,
                                             const std::string& xent) {
  return AddOp("LabelCrossEntropy", {pred, label}, {xent});
}

OperatorDef* Net::AddAveragedLossOp(const std::string& input,
                                        const std::string& loss) {
  return AddOp("AveragedLoss", {input}, {loss});
}

OperatorDef* Net::AddDiagonalOp(const std::string& input,
...
OperatorDef* Net::AddBackMeanOp(const std::string& input,
...
OperatorDef* Net::AddMeanStdevOp(const std::string& input,
                                     const std::string& mean,
                                     const std::string& scale) {
  return AddOp("MeanStdev", {input}, {mean, scale});
}

OperatorDef* Net::AddAffineScaleOp(const std::string& input,
                                       const std::string& mean,
                                       const std::string& scale,
...
OperatorDef* Net::AddReshapeOp(const std::string& input,
                                   const std::string& output,
...
OperatorDef* Net::AddWeightedSumOp(const std::vector<std::string>& inputs,
                                       const std::string& sum) {
  return AddOp("WeightedSum", inputs, {sum});
}

OperatorDef* Net::AddCheckpointOp(const std::vector<std::string>& inputs,
...
OperatorDef* Net::AddMomentumSgdOp(const std::string& param,
...
OperatorDef* Net::AddAdagradOp(const std::string& param,
                                   const std::string& moment,
                                   const std::string& grad,
                                   const std::string& lr) {
...
OperatorDef* Net::AddAdamOp(const std::string& param,
...
OperatorDef* Net::AddRmsPropOp(const std::string& grad,
...
OperatorDef* Net::AddScaleOp(const std::string& input,
...
OperatorDef* Net::AddClipOp(const std::string& input,
...
OperatorDef* Net::AddCastOp(const std::string& input,
                                const std::string& output,
...
OperatorDef* Net::AddStopGradientOp(const std::string& param) {
  return AddOp("StopGradient", {param}, {param});
}

OperatorDef* Net::AddIterOp(const std::string& iter) {
  return AddOp("Iter", {iter}, {iter});
}

OperatorDef* Net::AddAtomicIterOp(const std::string& mutex,
                                      const std::string& iter) {
  return AddOp("AtomicIter", {mutex, iter}, {iter});
}

OperatorDef* Net::AddLearningRateOp(const std::string& iter,
...
void Net::AddInput(const std::string input) {
  net_.add_external_input(input);
}

void Net::AddOutput(const std::string output) {
  net_.add_external_output(output);
}

void Net::SetName(const std::string name) { net_.set_name(name); }

void Net::SetType(const std::string type) { net_.set_type(type); }

void Net::SetFillToTrain() {
...
void Net::SetEngineOps(const std::string engine) {
  for (auto& op : *net_.mutable_op()) {
...
std::map<std::string, int> Net::CollectParamSizes() {
...
std::vector<std::string> Net::CollectParams() {
...
std::vector<OperatorDef> Net::CollectGradientOps() {
  std::set<std::string> external_inputs(net_.external_input().begin(),
                                        net_.external_input().end());
...
std::set<std::string> Net::CollectLayers(const std::string& layer,
                                             bool forward) {
...
void Net::CheckLayerAvailable(const std::string& layer) {
...
std::string Net::Short() { return net_short_net(net_); }
...
void Net::SetDeviceCUDA() {
#ifdef WITH_CUDA
  net_.mutable_device_option()->set_device_type(CUDA);
#endif
}

OperatorDef* Net::AddRecurrentNetworkOp(const std::string& seq_lengths,
